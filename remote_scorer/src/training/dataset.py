...
class TripletDataset(Dataset):
    ...
    def __init__(self, data: List[Dict], config: DataConfig, processor: AutoProcessor, is_train: bool):
        ...
        # 定义图像变换
        # 注意: Qwen-VL 通常不强制要求 resize，但为了增加 token 数量和细节，我们这里强行 resize
