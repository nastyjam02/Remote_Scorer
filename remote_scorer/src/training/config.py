...
class ModelConfig:
    """模型配置"""
    # 预训练模型路径
    model_path: str = "/.cache/modelscope/hub/models/Qwen/Qwen2.5-VL-3B-Instruct"
    # 是否冻结视觉编码器
...
class DataConfig:
    ...
    # 训练集图像根目录
    train_image_root: str = "/Score/imgs"
    # 验证集图像根目录
    val_image_root: str = "/Score/imgs"
    # 图像尺寸
    image_size: int = 512 # 256
    # 是否启用数据增强
